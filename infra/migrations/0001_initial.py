...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('origem_processo', models.CharField(blank=True, max_length=120)),
                ('tipo_processo', models.CharField(blank=True, max_length=120)),
                ('assunto_detalhado', models.TextField(blank=True, max_length=120)),
            ],
        ),
        migrations.CreateModel(
            name='Processo',
            fields=[
                ...
                ('natureza_processo', models.CharField(choices=[('Ostensivo', 'Ostensivo'), ('Restrito', 'Restrito')], default='Ostensivo', max_length=40)),
